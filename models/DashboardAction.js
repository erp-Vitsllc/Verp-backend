...
const dashboardActionSchema = new mongoose.Schema({
    ...
    requestType: {
        type: String,
        required: true,
        enum: ['Loan', 'Reward', 'Fine', 'Group Fine Request', 'Profile Activation', 'Notice Request', 'Company Activation', 'Asset', 'Asset Overdue', 'Asset Approval', 'Asset Assignment', 'Asset Transfer', 'Asset Loss Damage', 'Asset End of Life', 'Asset Accessory', 'Asset Accessory Approval', 'Asset Accessory Unattach', 'Asset Return', 'Responsibility Approval', 'Asset Leave', 'Asset Bulk Action', 'Asset Owner On Duty', 'Asset On Duty Request', 'Payment Approval', 'Vehicle Service Request', 'Vehicle Profile Activation', 'Vehicle Profile Edit', 'Vehicle Inspection', 'Vehicle Mortgage Close', 'Vehicle Disposition Request', 'Vehicle Document Expiry Reminder', 'Document Expiry Reminder', 'Employee Document Expiry Reminder', 'Probation Change', 'Company Document Not Renew', 'Employee Document Not Renew', 'Card Deleted Progress']
    },
    status: {
        type: String,

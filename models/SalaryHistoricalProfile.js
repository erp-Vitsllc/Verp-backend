...
const paymentCycleSchema = new mongoose.Schema(
    {
        ...
        salarySlipMonthKey: { type: String, default: '' },
...
const salaryHistoricalProfileSchema = new mongoose.Schema(
    {
        ...
        joiningDateReason: { type: String, default: '' },
        ...
        enrollmentCleared: { type: Boolean, default: false },
        enrollmentResetAt: { type: Date, default: null },

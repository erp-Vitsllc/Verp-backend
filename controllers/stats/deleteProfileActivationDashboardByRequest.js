...
/**
 * Delete all Profile Activation dashboard rows for an employee request that the viewer is allowed to remove.
 * Used when the UI has requestId (employee Mongo id) but no actionId (e.g. fallback inbox rows).
 */
export const deleteProfileActivationDashboardByRequest = async (req, res) => {
    try {
        ...
        console.error("[deleteProfileActivationDashboardByRequest]", error);

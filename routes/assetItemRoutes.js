...
router.get('/vehicle-access-services', protect, getVehicleAccessServices);
router.get('/vehicle-access-handovers', protect, getVehicleAccessHandovers);
...
router.post(
    '/:id/handover/:historyId/service-photo-review',
    protect,
    resolveServicePhotoReviewHandler,
);
router.post(
    '/:id/service/:serviceId/sync-body-condition-photos',
    protect,
    requireAssetFullAccess,
    syncServiceBodyConditionPhotosHandler,
);
router.post('/:id/service/:serviceId/garage-zoho-bill', protect, requireAssetFullAccess, retryGarageZohoBillHandler);

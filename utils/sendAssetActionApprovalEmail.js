        ...
        const htmlContent = `
            <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #eaeaea; border-radius: 8px; overflow: hidden;">
                ...
                <div style="padding: 20px;">
                    ...
                    ${att.length ? `<p style="font-size: 13px; color: #64748b;">The attached <strong>Asset Handover Form</strong> includes the <strong>requester&rsquo;s</strong> name and signature (not the Asset Controller&rsquo;s).</p>` : ''}

            ...
            html: `
                <div style="font-family:Arial,sans-serif;color:#334155;max-width:600px;margin:0 auto;border:1px solid #e2e8f0;border-radius:10px;overflow:hidden">
                    ...
                    <div style="padding:20px">
                        ...
                        ${att.length ? '<p style="font-size:12px;color:#64748b;">The attached <strong>Asset Handover Form</strong> includes the original handover party&rsquo;s signature and your name and signature under <strong>Received and Acknowledge</strong>.</p>' : ''}

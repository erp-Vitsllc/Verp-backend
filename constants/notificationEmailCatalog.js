        ...
        modules: [
            ...
            },
            {
                ...
                items: [
                    ...
                    row({
                        key: 'hrm.fine.approved',
                        label: 'Fine approved',
                        hint: 'Company email gets the fine PDF. If there is no company email, the PDF goes to WhatsApp.',
                        detail: 'When a fine is fully approved and this is on: if the employee has a company email, the fine PDF goes to that company email. If they have no company email, the PDF is sent only to their WhatsApp number.',
                        types: ['Fine Approved'],
                        emailTypes: ['FineApproved'],
                    }),
                ],
            },
            {
                ...
                items: [
                    ...
                    row({
                        ...
                        detail: 'When a loan is fully approved and this is on: if the employee has a company email, the acknowledgment PDF goes to that company email. If they have no company email, the PDF is sent only to their WhatsApp number.',
                        types: ['Loan Approved'],
                    ...
                    row({
                        ...
                        detail: 'When an advance is fully approved and this is on: if the employee has a company email, the acknowledgment PDF goes to that company email. If they have no company email, the PDF is sent only to their WhatsApp number.',
            ...
            },
            {
                ...
                items: [
                    ...
                    row({
                        ...
                        hint: 'Company email gets the assignment PDF. If there is no company email, the PDF goes to WhatsApp.',
                        detail: 'When a tool is assigned or transferred and this is on: if the employee has a company email, the asset assignment PDF goes to that company email. If they have no company email and they have a WhatsApp number, the handover PDF is sent to that number.',
                    ...
                    row({
                        ...
                        hint: 'On the 1st of each month, the assigned-asset PDF goes to each active employee WhatsApp number.',
                        detail: 'On the 1st of every month, each active employee who has a WhatsApp number receives the PDF of assets assigned to them. The PDF is reported by the asset controller.',
            ...
            },
            {
                ...
                items: [
                    ...
                    row({
                        ...
                        hint: 'If the employee has a WhatsApp number, the vehicle handover attachment is sent there.',
                        detail: 'When a vehicle is handed over and this is on, the handover attachment PDF is sent to that employee WhatsApp number when they have one.',
